...
//        {
//            List<RawInput> inputs = Arrays.asList(
//                    new RawInput(null, 0, null, null, 0L));
//
//            Map<String, BigDecimal> outputs = new HashMap<>();
//            outputs.put("mkedpaeZELrF36mjpNmEdmLznN7YKKHVSV", new BigDecimal("0.299"));
//            outputs.put("mh2GwDCi8rhm319vRLyLyDTPgmnFLprwb7", new BigDecimal("1.900"));
//
//
//            String hex = client.createRawTransaction(inputs, outputs);
//
//            SignatureResult result = client.signRawTransaction(hex);
//            System.out.println(result);
//
//            client.sendRawTransaction(hex);
//        }
//        client.generate(100, null);
        System.out.println(client.getBalance());

        String depositAddress = "mvbnrCX3bg1cDRUu8pkecrvP6vQkSLDSou";
        client.importAddress(depositAddress);
        client.sendToAddress(depositAddress, new BigDecimal(".2"));
//        client.sendToAddress("mvbnrCX3bg1cDRUu8pkecrvP6vQkSLDSou", new BigDecimal(".2"));


//        {
//            List<RawInput> inputs = Arrays.asList(
//                    new RawInput("c61706760cbae899d8ef130c6d6405ce67c163340c7f78a5388c1adb44e271a7", 0, null, null, 0L));
//
//            Map<String, BigDecimal> outputs = new HashMap<>();
//            outputs.put("mkedpaeZELrF36mjpNmEdmLznN7YKKHVSV", new BigDecimal("0.299"));
//            outputs.put("mh2GwDCi8rhm319vRLyLyDTPgmnFLprwb7", new BigDecimal("1.900"));
